...
if ((length(setdiff(thms$Themes, unique(dta_th$Themes))) | 
  ...
  message("… so in case it's an issue of the theme names in dta_th having a typo, these were replaced with the accurate corresponding ones from the thms dataframe.")
...
if ((length(setdiff(thms$Themes, unique(dta_tt$Theme))) | 
  ...
  message("… so in case it's an issue of the theme names in dta_tt having a typo, these were replaced with the accurate corresponding ones from the thms dataframe.")
